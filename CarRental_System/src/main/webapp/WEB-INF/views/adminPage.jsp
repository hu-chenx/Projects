...
<script src="/resources/admin_2_2.js"></script>
...
<a href="/controller/admin/listCar">list_Car</a>
<a href="/controller/admin/listUser">list_User</a>
<a href="/controller/admin/AddCar">Add_Car</a>
<a href="/controller/logout">log out</a>


   <c:if test="${!empty messages }">
           <a href="/controller/admin/ViewMessage">New Message!</a>
       </c:if> 
...
<form:form action="/controller/admin/searchCar" modelAttribute="searchInfo" role="form">
            <table>
             <tr>
                  <td>
         ...
         <table>
              ...
              <c:forEach items="${cars}" var="car">
                 <tr> 
                    ...
                    <td>${car.location }</td>
                    <td>
                    <a href="/controller/admin/process/${car.id}">Process</a>
                    </td>
                 </tr>
